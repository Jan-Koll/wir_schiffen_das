...
func postAnalysisHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		w.Write([]byte("Could not decode body. Please only provide a valid configuration_id or optionally a order_created_at timestamp"))
		return
	}
	// Required fields
