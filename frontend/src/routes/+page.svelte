		...
		<Card.Content class="grid gap-8">
			<div class="flex items-center gap-4">
				<Avatar.Root class="hidden h-9 w-9 sm:flex">
					<Avatar.Fallback class="bg-gray-300 dark:bg-gray-700">OM</Avatar.Fallback>
				</Avatar.Root>
			...
			<div class="flex items-center gap-4">
				<Avatar.Root class="hidden h-9 w-9 sm:flex">
					<Avatar.Fallback class="bg-gray-300 dark:bg-gray-700">JL</Avatar.Fallback>
				</Avatar.Root>
				<div class="grid gap-1">
			...
			<div class="flex items-center gap-4">
				<Avatar.Root class="hidden h-9 w-9 sm:flex">
					<Avatar.Fallback class="bg-gray-300 dark:bg-gray-700">IN</Avatar.Fallback>
				</Avatar.Root>
				<div class="grid gap-1">
			...
			<div class="flex items-center gap-4">
				<Avatar.Root class="hidden h-9 w-9 sm:flex">
					<Avatar.Fallback class="bg-gray-300 dark:bg-gray-700">WK</Avatar.Fallback>
				</Avatar.Root>
				<div class="grid gap-1">
			...
			<div class="flex items-center gap-4">
				<Avatar.Root class="hidden h-9 w-9 sm:flex">
					<Avatar.Fallback class="bg-gray-300 dark:bg-gray-700">SD</Avatar.Fallback>
				</Avatar.Root>
				<div class="grid gap-1">
